...
import PlanetInfoModal from '../ui/PlanetInfoModal';
...
const NavagrahaBooking = ({ onBookService }) => {
  ...
  return (
    <section id="navagraha" className="section section--alt container" style={{ position: 'relative' }}>
      ...
      <p style={{ textAlign: 'center', marginBottom: '60px', color: colors.text, opacity: 0.8, fontSize: '1.1rem' }}>
        Tap on any planet to learn about its cosmic influence, Vedic significance, and remedies.
      </p>
      ...
      <div className="navagraha-grid" style={{
        ...
        {PLANETS.map((planet, index) => (
          ...
          >
            ...
            <p style={{ fontSize: '0.85rem', color: colors.secondary, opacity: 0.95, textAlign: 'center', zIndex: 1, letterSpacing: '0.02em', marginBottom: '12px' }}>
              {planet.meaning}
            </p>
            <div style={{
              fontSize: '0.72rem', color: planet.color, fontWeight: 700,
